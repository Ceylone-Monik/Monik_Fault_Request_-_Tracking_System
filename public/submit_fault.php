...
<div class="container" style="max-width:640px;">
    ...
    <div class="text-center mb-4 fade-in">
        <div style="display:inline-flex;align-items:center;justify-content:center;width:56px;height:56px;background:linear-gradient(135deg,var(--accent-green),#16a34a);border-radius:16px;margin-bottom:1rem;box-shadow:0 8px 24px rgba(34,197,94,0.35);">
            <i class="fas fa-paper-plane" style="font-size:1.4rem;color:#fff;"></i>
        </div>
